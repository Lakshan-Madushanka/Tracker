<div
    ...
    @delete-category.window="errorId=$event.detail.id;show=true"
    @@category-deleted="show=false"
>
    <dialog id="my_modal_3" class="modal" :open="show">
        <div class="modal-box">
            ...
            <div class="flex justify-end gap-x-4">
                ...
                <button wire:click="delete(errorId)" class="btn btn-info flex justify-center items-center text-center gap-2">
                    <span>Confirm</span>
